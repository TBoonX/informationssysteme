...
Die Architektur wurde entsprechend der Vorlesung Informationssysteme entwurfen.
...
Da die Datenquellen JSON als Format liefern und die Umwandlung in ein solches wenig aufwendig ist, wurde als Stating Area die schemafreie dokumentbasierte Datenbank MongoDB verwendet. Außerdem 
